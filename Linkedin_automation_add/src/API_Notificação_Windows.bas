Attribute VB_Name = "API_Notificação_Windows"
Option Explicit
...
Public Function Windows_Notification(Optional ByVal title As String, Optional ByVal info As String, Optional ByVal flag As Long)
